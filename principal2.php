...
<head>
  ...
  <link rel="stylesheet" href="assets/css/principal2.css">
      ...
      <ul class="nav-menu">
        ...
        <ul class="nav-menu">
         ...
         <!-- <li class="nav-menu-item">
          ...
          <li class="nav-menu-item">
            <a href="#aip-form" class="nav-menu-link nav-link">AIP</a>
            <div class="nav-menu-item-content">
              <a href="formulario_aip.php?accion=donacion">Donación</a>
          <!--    <a href="formulario_aip.php?accion=voluntario">Voluntario</a>-->
              <a href="formulario_aip.php?accion=proyectos">Proyectos</a>
              <a href="formulario_aip.php?accion=eventos">Eventos</a>
            </div>
            </li>
          <li class="nav-menu-item">
            <a href="consultoria_AIP.php" class="nav-menu-link nav-link">consultoria AIP </a>
          </li>
          <li class="nav-menu-item">
